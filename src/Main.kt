fun main() {
    ...
    println("La primera constante es: ${fecha}")
    println("El numero PI es: ${pi}")
    ...
    println("La segunda variable explicita es: ${resultado}")
    println("La tercera variable explicita es: ${caracter}")
